//
// Created by harsh on 11-08-2023.
//
...
static void openCamera(ACameraDevice_request_template templateId) {
    ...
    selectedCameraId = NdkCamera::getBackFacingCamId(cameraManager).c_str();
    ...
    ACameraMetadata_getConstEntry(cameraMetadata,ACAMERA_SENSOR_INFO_EXPOSURE_TIME_RANGE, &entry);
    ...
    AImageReader_new(1280,
                     720,
                     AIMAGE_FORMAT_YUV_420_888, /*maxImages*/
                     2,
                     &image_reader);
...
Java_com_example_opencvtest2_MainActivity_startPreview(JNIEnv *env,
                                                       jclass clazz,
                                                       jobject surface) {
...
extern "C" JNIEXPORT void JNICALL Java_com_example_opencvtest2_MainActivity_stopPreview(JNIEnv *env,
                                                                                        jclass clazz) {
    closeCamera();
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_opencvtest2_MainActivity_startExtraView(JNIEnv *env,
                                                         jclass clazz,
                                                         jobject surface) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_opencvtest2_MainActivity_stopExtraView(JNIEnv *env,jclass clazz) {
